...
header("Expires: Mon, 24 Jan 2022 05:00:00 GMT"); // Fecha en el pasado
?>
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login  - Interfaz Datos</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="titulo height">Biblioteca </span>
									<span class="titulo-1" id="id-text2">Lirvan </span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Lirvan - copyright 2022</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
											    <i class="fa-address-book fa fa-address-book"></i>
											...
											<form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST" >
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit"name="ingresar" class="btn-primary2" style="margin-left:75px;">
											...
											<div class="social-or-login center">
												<span class="bigger-110">Sino cuentas con usuario y contraseña, puedes solicitarlo al correo servicioalcliente@lirvan.com</span>
											</div>
										...
										<div class="toolbar clearfix">
											<div>
												<a href="#" data-target="#forgot-box" class="forgot">
											...
											<div>
												<a href="#" data-target="#signup-box" class="newre">
													Nuevo Registro
